...
chsource = Redis:get(Fast..'chsource') or "WX_PM"
devsource = Redis:get(Fast..'devsource') or "WZAERE"
function var(value)  
...
local UserId_Info = bot.searchPublicChat("WZAERE")
...
local TestText = "  ❲ 𓂄✭𓆩𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢𓆪✭𓂁 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯⎖᳒𝘿𝙀𝙑⌯⤹𝗧𝗘𝗧𝗢⤸► ◞', url = "https://WZAERE"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄✭𓆩𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢𓆪✭𓂁 ❳', url = "https://t.me/WZAERE"}
},
{
{text = '❲ ⁨𓂄✭𓆩𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢𓆪✭𓂁 ❳', url = "https://t.me/WX_PM"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'تيتو' or text == 'مطور سورس' or text == 'مرات تيتو' then  
local UserId_Info = bot.searchPublicChat("NONE")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/G_7_Rr"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج فيجا ❳', url = "https://t.me/WZAERE"}
},
{
{text = '❲ ⁨𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢 ❳', url = "https://t.me/WX_PM"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'مطور سورس' or text == 'تيتو' then  
...
if text == 'مرات تيتو' or text == 'تالنينبنبنينا' then  
...
if text == 'تيتو' or text == 'المبرمج' then  
local UserId_Info = bot.searchPublicChat("WZAERE")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢◞◞˼⁩ ,❳\nᥫ᭡\n ✭ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✭  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑 𝗧𝗘𝗧𝗢  .', url = 't.me/WZAERE'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
bot.sendText(55893347792,0,'*\n✭  مرحباً عزيزي المبرمج تيتو \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨𓂄✭𓆩𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢𓆪✭𓂁 ,━━━━⩺ \n✭  اسمه ↫ '..klajq..' \n✭  ايديه ↫  : '..msg.sender_id.user_id..'\n✭  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'تيتو' or text == 'مبرمج السورس' then  
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
data = {
{
{text = '◜ ⎖᳒𝘿𝙀𝙑⌯⤹𝗧𝗘𝗧𝗢⤸►◞', url = 't.me/'..devsource}, 
},
{
{text = '◜𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢⚡️◞', url = 'http://t.me/'..chsource..''}, 
},
{
...
⍟ 𝚆𝙴𝙻𝙲𝙾𝙼 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚃𝙾
⌯━─━─𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢─━─━⌯
★ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢](https://t.me/WX_PM) 
★ [𝙈𝘼𝙆𝙀𝙍 𝗧𝗘𝗧𝗢](https://t.me/MakerTetoBot) 
★ [𝗧𝗘𝗧𝗢](https://t.me/WZAERE) 
★ [𝙃𝙖𝙈𝙖𝙎𝙖](https://t.me/G_7_Rr) 
⌯━─━─𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢─━─━⌯
...
{
{text = '☢️ › إضغط هنا لتنصيب بوتك', url = 't.me/MakerTetoBot?start'}
},
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
},
...
'\n🔮⋮ ارسل كلمة { /Teto} لاظهار الكيبورد'..
'\n💥⋮ مطور البوت -›«@'..UserSudo..'»*'
...
if text == '/Teto' or text == 'عوده' or text == 'رجـوع ✭' then  
Redis:sadd(Fast..'Num:User:Pv',msg.sender_id.user_id)  
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
...
data = {
{
{text = '« تيتو»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if text == 'مبرمج السورس ✭' or text == 'مبرمج السورس' or text == 'تيتو' then  
local UserId_Info = bot.searchPublicChat("WZAERE")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢◞ ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 𝗧𝗘𝗧𝗢 ❳', url = "https://t.me/WZAERE"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج تيتو ', url = "https://t.me/WZAERE"}
},
{
{text = '◜𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗧𝗢◞', url = "https://t.me/WX_PM"},
},
